### Geothermal Energy
*TD:DR* Geothermal Energy is natural heat of the earth derived from the decay of the radioactive elements in the earth’s crust and transferred to the subsurface by conduction and convection. Geothermal springs have for centuries been used for bathing, heating, and cooking but in the early 20th century people started to consider geothermal as a source of energy. Geothermal energy is now used to produce electricity , heat/cool buildings and cultivate fruits and vegetables. It is considered a sustainable and renewable source of energy because the heat extraction is minor compared with the earth's heat content.  
Technologies to extract geothermal power include Dry steam, Flash steam and Binary cycle plants. All these methods require that multiple boreholes be drilled into the heat reservoir in the earth, and fluid be cycled through by a power plant thereby accessing the thermal energy. Capital costs are significant with drilling accounting for more than half the costs. Therefore, there is strong interest in re-purposing already existing oil and gas wells for geothermal energy with the main benefits being costs, surface infrastructure and CO2 reductions.
<details>
